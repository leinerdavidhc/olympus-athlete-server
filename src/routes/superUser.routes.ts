...
export default class SuperUserRouter{
    ...
    private initializer(){
        ...
        this.router.post("/superuser/dashboard/register",SuperUserMiddleware.validateRegister,SuperUserController.register)
        this.router.get("/superuser/dashboard/logout",SuperUserController.Logout)
        this.router.get("/superuser/dashboard/protected",SuperUserController.Protected)
    }
}